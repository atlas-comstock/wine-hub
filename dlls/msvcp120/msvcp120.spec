...
@ cdecl -arch=win32 ?_Close_dir@sys@tr2@std@@YAXPAX@Z(str) tr2_sys__Close_dir
@ cdecl -arch=win64 ?_Close_dir@sys@tr2@std@@YAXPEAX@Z(str) tr2_sys__Close_dir
...
@ cdecl -arch=win32 ?_Read_dir@sys@tr2@std@@YAPADAAY0BAE@DPAXAAW4file_type@123@@Z(str ptr ptr) tr2_sys__Read_dir
@ cdecl -arch=win64 ?_Read_dir@sys@tr2@std@@YAPEADAEAY0BAE@DPEAXAEAW4file_type@123@@Z(str ptr ptr) tr2_sys__Read_dir

...
@ cdecl -arch=arm ??1_Condition_variable@details@Concurrency@@QAA@XZ(ptr) condition_variable_ctor
@ thiscall -arch=i386 ??1_Condition_variable@details@Concurrency@@QAE@XZ(ptr) condition_variable_ctor
@ cdecl -arch=win64 ??1_Condition_variable@details@Concurrency@@QEAA@XZ(ptr) condition_variable_ctor
...
@ cdecl -arch=arm ??1event@Concurrency@@QAA@XZ(ptr) concurrency_event_dtor
@ thiscall -arch=i386 ??1event@Concurrency@@QAE@XZ(ptr) concurrency_event_dtor
@ cdecl -arch=win64 ??1event@Concurrency@@QEAA@XZ(ptr) concurrency_event_dtor
...
@ cdecl -arch=arm ?_RunAndWait@_TaskCollection@details@Concurrency@@QAA?AW4_TaskCollectionStatus@23@PAV_UnrealizedChore@23@@Z(ptr) concurrency_details__taskcollection__runandwait
@ stdcall -arch=i386 ?_RunAndWait@_TaskCollection@details@Concurrency@@QAG?AW4_TaskCollectionStatus@23@PAV_UnrealizedChore@23@@Z(ptr) concurrency_details__taskcollection__runandwait
@ cdecl -arch=win64 ?_RunAndWait@_TaskCollection@details@Concurrency@@QEAA?AW4_TaskCollectionStatus@23@PEAV_UnrealizedChore@23@@Z(ptr) concurrency_details__taskcollection__runandwait
...
@ cdecl -arch=arm ?_Schedule@_TaskCollection@details@Concurrency@@QAAXPAV_UnrealizedChore@23@@Z(ptr) concurrency_details__taskcollection__schedule
@ thiscall -arch=i386 ?_Schedule@_TaskCollection@details@Concurrency@@QAEXPAV_UnrealizedChore@23@@Z(ptr) concurrency_details__taskcollection__schedule
@ cdecl -arch=win64 ?_Schedule@_TaskCollection@details@Concurrency@@QEAAXPEAV_UnrealizedChore@23@@Z(ptr) concurrency_details__taskcollection__schedule
...
@ cdecl -arch=arm ?notify_all@_Condition_variable@details@Concurrency@@QAAXXZ(ptr) condition_variable_notify_all
@ thiscall -arch=i386 ?notify_all@_Condition_variable@details@Concurrency@@QAEXXZ(ptr) condition_variable_notify_all
@ cdecl -arch=win64 ?notify_all@_Condition_variable@details@Concurrency@@QEAAXXZ(ptr) condition_variable_notify_all
...
@ cdecl -arch=arm ?set@event@Concurrency@@QAAXXZ(ptr) concurrency_event_set
@ thiscall -arch=i386 ?set@event@Concurrency@@QAEXXZ(ptr) concurrency_event_set
...
@ cdecl -arch=arm ?wait_for@_Condition_variable@details@Concurrency@@QAA_NAAVcritical_section@3@I@Z(ptr ptr long) condition_variable_wait_for
@ thiscall -arch=i386 ?wait_for@_Condition_variable@details@Concurrency@@QAE_NAAVcritical_section@3@I@Z(ptr ptr long) condition_variable_wait_for
@ cdecl -arch=win64 ?wait_for@_Condition_variable@details@Concurrency@@QEAA_NAEAVcritical_section@3@I@Z(ptr ptr long) condition_variable_wait_for
